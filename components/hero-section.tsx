      ...
      <div className="max-w-6xl mx-auto text-center z-10">
        ...
        >
          ...
          >
            ...
            <span className="text-sm font-mono text-primary">Next-Gen VPN Technology</span>
          </motion.div>
          ...
          <p className="text-xl md:text-2xl text-muted-foreground max-w-3xl mx-auto leading-relaxed">
            Experience the future of secure connectivity with cutting-edge{" "}
            <span className="text-primary font-mono font-semibold">VLESS</span> protocol technology
          </p>
